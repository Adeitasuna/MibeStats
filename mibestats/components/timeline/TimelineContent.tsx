...
export function TimelineContent() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Treemap */}
      {loading && !response ? (
        <div className="card h-[350px] md:h-[450px] lg:h-[550px] flex flex-col items-center justify-center gap-3">
          <svg className="w-8 h-8 text-mibe-gold animate-spin" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
          </svg>
          <span className="text-mibe-text-2 text-sm">Loading timeline data...</span>
        </div>
      ) : (
